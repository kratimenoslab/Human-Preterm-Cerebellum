...
through **relative paths only** (place the Data S1–S5 files in a `Supplementary_Datasets/` folder at the
repository root; Data S4 is extracted from its zip automatically). No machine-
