...
These read the de-identified source data provided with the journal submission (resolved through relative
`Supplementary_Datasets/` paths). The mapping from each figure/table to the analysis folders above is given in
